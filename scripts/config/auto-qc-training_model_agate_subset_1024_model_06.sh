...
export AUTO_QC_CACHE_DIR=/scratch.global/lundq163/auto_qc_model_06_cache/
...
--model-save-location "/scratch.global/lundq163/auto_qc_model_06/model_06.pt" \
--plot-location "/users/1/lundq163/projects/automated-qc/doc/models/model_06/model_06.png" \
...
--csv-output-file "/users/1/lundq163/projects/automated-qc/doc/models/model_06/model_06.csv" \
