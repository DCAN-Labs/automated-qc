...
export AUTO_QC_CACHE_DIR=/scratch.global/lundq163/auto_qc_model_03s_cache/
...
--model-save-location "/scratch.global/lundq163/auto_qc_model_03s/model_03s.pt" \
--plot-location "/users/1/lundq163/projects/automated-qc/doc/models/model_03s/model_03s.png" \
--folder "/scratch.global/lundq163/auto_qc_subset_4096s/" \
--csv-input-file "/users/1/lundq163/projects/automated-qc/data/raw/auto_qc_t1w_t2w_subset_4096s.csv" \
--csv-output-file "/users/1/lundq163/projects/automated-qc/doc/models/model_03s/model_03s.csv" \
