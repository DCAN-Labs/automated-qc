...
#SBATCH --job-name=fold # job name (will be updated by master script)
...
#SBATCH -e logs/automated-qc-Regressor-fold-%j.err
#SBATCH -o logs/automated-qc-Regressor-fold-%j.out
#SBATCH -A feczk001

# This script trains a single fold in parallel. 
...
--plot-location "/users/1/lundq163/projects/automated-qc/doc/models/model_02r7/model_02r7.png" \
...
--csv-output-file "/users/1/lundq163/projects/automated-qc/doc/models/model_02r7/model_02r7.csv" \
