...
export AUTO_QC_CACHE_DIR=/scratch.global/lundq163/auto_qc_model_02rs_cache/
...
--model-save-location "/scratch.global/lundq163/auto_qc_model_02rs/model_02rs.pt" \
--plot-location "/users/1/lundq163/projects/automated-qc/doc/models/model_02rs/model_02rs.png" \
--folder "/scratch.global/lundq163/auto_qc_subset_1024rs/" \
--csv-input-file "/users/1/lundq163/projects/automated-qc/data/raw/auto_qc_t1w_t2w_subset_1024rs.csv" \
--csv-output-file "/users/1/lundq163/projects/automated-qc/doc/models/model_02rs/model_02rs.csv" \
