...
#SBATCH --job-name=fold_3_redo
#SBATCH -e /users/1/lundq163/projects/automated-qc/scripts/utils/logs/automated-qc-Regressor-fold_3_redo-%j.err
#SBATCH -o /users/1/lundq163/projects/automated-qc/scripts/utils/logs/automated-qc-Regressor-fold_3_redo-%j.out
...
FOLD_IDX=3
FOLD_CSV="/users/1/lundq163/projects/automated-qc/doc/models/model_02r7/fold_assignments_02r7/fold_3_subset.csv"
