...
#SBATCH --job-name=fold_2_redo
#SBATCH -e /users/1/lundq163/projects/automated-qc/scripts/utils/logs/automated-qc-Regressor-fold_2_redo-%j.err
#SBATCH -o /users/1/lundq163/projects/automated-qc/scripts/utils/logs/automated-qc-Regressor-fold_2_redo-%j.out
...
FOLD_IDX=2
FOLD_CSV="/users/1/lundq163/projects/automated-qc/doc/models/model_02r7/fold_assignments_02r7/fold_2_subset.csv"
