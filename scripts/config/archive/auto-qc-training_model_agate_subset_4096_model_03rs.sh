...
export AUTO_QC_CACHE_DIR=/scratch.global/lundq163/auto_qc_model_03rs_cache/
...
--model-save-location "/scratch.global/lundq163/auto_qc_model_03rs/model_03rs.pt" \
--plot-location "/users/1/lundq163/projects/automated-qc/doc/models/model_03rs/model_03rs.png" \
--folder "/scratch.global/lundq163/auto_qc_subset_4096rs/" \
--csv-input-file "/users/1/lundq163/projects/automated-qc/data/raw/auto_qc_t1w_t2w_subset_4096rs.csv" \
--csv-output-file "/users/1/lundq163/projects/automated-qc/doc/models/model_03rs/model_03rs.csv" \
